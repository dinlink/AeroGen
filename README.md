...
AeroGen es un programa con interfaz gráfica para el diseño y análisis aerodinámico de turbinas eólicas de eje horizontal. Fue desarrollado en MATLAB por Abraham Vivas (ORCID: 0000-0003-4010-3883) durante su trabajo de fin de máster bajo la supervisión de Antonio Sánchez Káiser a finales de 2015. Entre las características disponibles se encuentran:
 ...
 - Estimación de tamaño de turbina para cubrir las necesidades de una instalación aislada (siguiendo el procedimiento enseñado durante el curso de ingeniería de sistemas eólicos impartido por la Universidad Politécnica de Cartagena) 
 - Diseño aerodinámico adimensional de la pala:
   + Permite el uso de perfiles diferentes a lo largo de la pala, interpolando comportamientos intermedios.
 ...
 - Análisis dimensional y optimización:  Determinación del tamaño y velocidad de giro del aerogenerador para la recuperación de energía a partir de un recurso eólico conocido (ajuste de Weibull).
